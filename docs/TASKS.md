...
- [x] **Enhanced Context Menu** — Right-click any file card for 8 organized actions: Copy Path (clipboard + toast), Select, Expand, Fit Content, Fit Screen, File History, Add to Layer (submenu), and Hide File. Logical grouping with dividers.
